...
\lstdefinelanguage{Groovy}{
  keywords={pipeline, agent, docker, image, args, environment, stages, stage, steps, script, sh, echo, dir, git, withCredentials, usernamePassword},
  keywordstyle=\color{teal}\bfseries,
  ndkeywords={def, returnStdout, trim, true, false, null},
...
\lstdefinelanguage{YAML}{
  ...
  moredelim=[l][\color{teal}\bfseries]{:}
}

\lstdefinelanguage{Nginx}{
  keywords={server, listen, server_name, root, index, location, set, resolver, proxy_pass, proxy_http_version, proxy_set_header, proxy_cache_bypass, proxy_pass_request_headers, return, add_header, expires, try_files},
  keywordstyle=\color{blue}\bfseries,
  comment=[l]{\#},
  stringstyle=\color{red},
  morestring=[b]',
