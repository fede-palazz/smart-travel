...
```
cd existing_repo
git remote add origin https://git.certimetergroup.com/lutech-certimeter-academy/stage/academy_federicopalazzi_smarttravel/bff-api.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.certimetergroup.com/lutech-certimeter-academy/stage/academy_federicopalazzi_smarttravel/bff-api/-/settings/integrations)
